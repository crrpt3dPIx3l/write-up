...
## Solution
Starting by downloading the file and checking the content,
...
This was the ouput of the file and flag is clearly was at the end of the message by decrypted in substitute technique I can say from the challenge name, so I went to see if there is an online decryptor and found one "https://www.guballa.de/substitution-solver".
